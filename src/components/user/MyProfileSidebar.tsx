...
//           <h2 className="text-xl font-bold text-gray-900 font-serif">Rahul Kumar</h2>
//           <p className="text-sm text-gray-500 flex items-center gap-1 mt-0.5">
//             <MapPin size={12} className="text-red-400" /> Mumbai, Maharashtra
//           </p>
//           <p className="text-xs text-gray-400 mt-1">28 yrs • Software Engineer • B.Tech</p>
...
//             whileTap={{ scale: 0.98 }}
//             className="flex items-center gap-3 w-full px-4 py-3.5 rounded-2xl bg-gradient-to-r from-red-700 via-red-600 to-amber-500 text-white mb-2 group shadow-lg shadow-red-100"
//           >
...
//               <p className="text-white/70 text-[11px]">Unlock unlimited matches</p>
//             </div>
//             <Sparkles size={16} className="text-amber-200 group-hover:rotate-12 transition-transform" />
//           </motion.a>
...
//             </div>
//             <span className="text-sm font-medium text-gray-700 group-hover:text-red-700 flex-1">Edit Preferences</span>
...
//             </div>
//             <span className="text-sm font-medium text-gray-700 group-hover:text-red-700 flex-1">Help & Support</span>
//             <ChevronRight size={14} className="text-gray-300 group-hover:text-red-400 transition-colors" />
//           </a>
//         </div>
//       </div>
...
//           />
//         </div>
//         <p className="text-xs text-gray-400 mt-2">Add education details to reach 85%</p>
//       </div>
//     </motion.aside>
//   );
// }
